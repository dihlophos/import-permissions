...
<form action="{{route('indi_export.store')}}" class="well" id="IndiExportAddForm" method="post" accept-charset="utf-8" class="form-horizontal">
    {{ csrf_field() }}
    <fieldset>
		<legend>Вывоз</legend>
		<div class="form-group required">
            <label for="individual">Физ. лицо</label>
            <input type="text" name="individual" id="individual" class="form-control">
        </div>
        <div class="form-group required">
